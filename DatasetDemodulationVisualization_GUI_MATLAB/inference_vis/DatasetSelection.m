function DatasetSelection(inferredFolder, interferenceFolder)

    % Crear la ventana principal
    fig = uifigure('Name', 'Load Dataset', 'Position', [100, 100, 600, 500]);

    % Obtener lista de modulaciones disponibles
    datasetFiles = dir(fullfile(interferenceFolder, '*.mat'));
    ...
    function loadModulationInfo()
        ...
        matFile = fullfile(interferenceFolder, [selectedModulation, '.mat']);
